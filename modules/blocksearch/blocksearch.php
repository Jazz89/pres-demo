...
class BlockSearch extends Module
{
	...
	{
		if (!parent::install() || !$this->registerHook('top') || !$this->registerHook('header') || !$this->registerHook('displayMobileTopSiteMap') ||  !$this->registerHook('headerContent') || !$this->registerHook('displaySearch'))
			return false;
		return true;
	}
...
*/
	...
	public function hookHeaderContent($params)
    {
