...
<div id="contact_block" class="block">
	...
	<div class="block_content clearfix">
		<div class"contact_warpper" style="margin-left:auto;
		margin-right:auto;
		height:auto; 
		width:auto;">
				p>{l s='Our support hotline is available 24/7.' mod='blockcontact'}</p>
				{if $telnumber != ''}<p  style="float:left" class="tel"><span class="label">{l s='Phone:' mod='blockcontact'}</span>
					
				<span style="float:left" itemprop="telephone"><a href="tel:{$telnumber|escape:'html':'UTF-8'}">{$telnumber|escape:'html':'UTF-8'}</a></span></p>{/if}
