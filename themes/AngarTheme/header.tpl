...
<html id="mycss" {if isset($language_code) && $language_code} lang="{$language_code|escape:'html':'UTF-8'}"{/if}>
	<head>
		...
		<link href="https://fonts.googleapis.com/css?family=Allura|Cookie|Courgette|Dancing+Script|Great+Vibes|Just+Another+Hand|Kaushan+Script|Leckerli+One|Niconne|Norican|Pacifico|Parisienne|Rancho|Sacramento|Satisfy|Sriracha|Tangerine|Yesteryear" rel="stylesheet">
						...
						<div class="container">
							<div class="row">
								<div id="header_content">	
									...
									{if isset($HOOK_HEADER_CONTENT)}{$HOOK_HEADER_CONTENT}{/if}
								</div>
								<div id="header_logo">
